...
public class RotatedPalindrome {
	...
	public static void main(String[] args) {
		...
		String str = "1234321";
		System.out.println("whether String :" + str + " palindrome ?: "
				+ obj.isPalindrome(str));

		String rotated = "3432112";
		System.out.println("Whether roated string :" + rotated
				+ " palindrome ?:" + obj.isRotatedPalindrome(rotated));
	}
	 ...
	 * helper function isPalindrome() takes O(n) time For each Substring loop
	 * iterates for O(n) hence total time : O(n^2)
	 */
